...
To build the final jar and optimize the jhipsterBankApplication application for production, run:
...
Then navigate to [http://localhost:1611](http://localhost:1611) in your browser.
